...
# Need to check for rounding etc when calculating the number of integers between them (inclusive)

# Maximum displacement (in case it's needed later) is halfway along the parabola
# i.e. at t/2
# s = 0.25 t^2
# This may not be an integer value but you can find the nearest integer later (bearing in mind we may need to deal with 0.5)
...
# Answer is number of ways in which we can beat the record, i.e. the number of integers between the intercepts
